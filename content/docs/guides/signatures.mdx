...
<Callout type="warn" title="Need a complete signing solution?">
  This library provides low-level PDF signing primitives. If you need a full document signing platform with workflows, templates, email notifications, and a signing portal, check out [Documenso](https://documenso.com) - the open-source DocuSign alternative.
</Callout>
